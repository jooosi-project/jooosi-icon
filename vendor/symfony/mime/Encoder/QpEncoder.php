 ...
 */
namespace JooosiIconDeps\Symfony\Component\Mime\Encoder;

use JooosiIconDeps\Symfony\Component\Mime\CharacterStream;
/**
 * @author Chris Corbyn
 */
class QpEncoder implements EncoderInterface
{
    ...
    private function standardize(string $string): string
    {
        ...
        return match ($end = $string[-1] ?? '') {
            "\t", " " => substr_replace($string, self::QP_MAP[\ord($end)], -1),
            default => $string,
        };
    }
}
