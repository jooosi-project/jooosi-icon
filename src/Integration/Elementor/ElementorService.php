...
class ElementorService
{
    ...
    public function editor_assets(): void
    {
        ...
        $this->viteService->enqueue_asset('resources/integration/elementor/editor.ts', ['handle' => JOOOSI_ICON::TEXT_DOMAIN . ':integration-elementor-editor', 'in_footer' => \true, 'dependencies' => ['wp-element', 'wp-components', 'wp-i18n', 'wp-data', 'react', 'react-dom']]);
    }
    /**
    ...
    {
        $elements_manager->add_category('jooosi-icon', ['title' => esc_html__('Jooosi Icon', 'jooosi-icon'), 'icon' => 'fa fa-star']);
    }
}
