...
final class SvgSanitizerAllowedAttributes extends AllowedAttributes
{
    ...
    {
        $attributes = array_filter(parent::getAttributes(), static fn(string $attribute): bool => strtolower($attribute) !== 'additivive');
        return array_values(array_unique([...$attributes, 'additive', 'calcMode', 'from', 'to']));
    }
}
