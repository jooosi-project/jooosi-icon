...
final class ServiceDiscovery implements \JooosiIcon\Core\Discovery\Discovery
{
    ...
    public function discover(\JooosiIcon\Core\Discovery\DiscoveryLocation $discoveryLocation, \JooosiIcon\Core\Discovery\ClassReflector $classReflector): void
    {
        ...
        $this->discoveryItems->add($discoveryLocation, ['className' => $classReflector->getName(), 'serviceId' => $serviceAttribute->id ?? $classReflector->getName(), 'singleton' => $serviceAttribute->singleton, 'public' => $serviceAttribute->public, 'tags' => $serviceAttribute->tags, 'alias' => $serviceAttribute->alias]);
    }
